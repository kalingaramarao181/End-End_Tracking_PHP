-- Use only if the earlier IRS-style w2_forms table was already created.
-- WARNING: this removes existing rows from that incorrect table.
DROP TABLE IF EXISTS w2_forms;
